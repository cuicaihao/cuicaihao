...
As a **Senior Data Scientist** (Data Analytics) and former **Control System Engineer** (Planning and Decesion Making), today I'm working mostly on Computer Vision, NLP and Deep Learning applications for data analysis with Python, Java, JS and C/C++! I'm also an avid contributor to open source communities and love to create and develop new projects and ideas around NLP and Graph Algorithms!
